...
/**
 * Validate a session from a signed cookie. The cookie value must contain sessionId & userId.
 * If the cookie is signed, it will be unsign-validated using Fastify's unsignCookie helper.
 *
